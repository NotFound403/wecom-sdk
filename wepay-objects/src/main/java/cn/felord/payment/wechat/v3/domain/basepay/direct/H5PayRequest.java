...
public class H5PayRequest {
     ...
     */
    public H5PayRequest(String notifyUrl, String description, String outTradeNo, Amount amount, SceneInfo sceneInfo) {
     ...
     */
    public H5PayRequest timeExpire(OffsetDateTime timeExpire) {
     ...
     * @return the js pay request
     */
    public H5PayRequest attach(String attach) {
        this.attach = attach;
        return this;
    }
     ...
     * @return the js pay request
     */
    public H5PayRequest goodsTag(String goodsTag) {
     ...
     * @return the js pay request
     */
    public H5PayRequest detail(Detail detail) {
        this.detail = detail;
        return this;
    }
     ...
     * @return the js pay request
     */
    public H5PayRequest supportFapiao(boolean supportFapiao) {
     ...
     * @return the info
     */
    public H5PayRequest settleInfo(SettleInfo settleInfo) {
