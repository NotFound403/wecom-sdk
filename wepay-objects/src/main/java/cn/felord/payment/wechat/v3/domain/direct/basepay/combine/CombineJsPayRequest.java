...
public class CombineJsPayRequest {
     ...
     */
    public CombineJsPayRequest sceneInfo(CombineSceneInfo sceneInfo) {
     ...
     * @return the combine app pay request
     */
    public CombineJsPayRequest timeStart(OffsetDateTime timeStart) {
     ...
     * @return the combine app pay request
     */
    public CombineJsPayRequest timeExpire(OffsetDateTime timeExpire) {
