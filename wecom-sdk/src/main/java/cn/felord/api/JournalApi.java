...
public interface JournalApi {
    ...
    JournalRecordResponse getRecordList(@Body JournalRecordRequest request) throws WeComException;
    ...
    GenericResponse<String> exportDoc(@Body JournalExportRequest request) throws WeComException;
