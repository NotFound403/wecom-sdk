...
/**
 * The type Selector apply content data.
 *
 * @author dax
 * @since 2024/5/27
 */
public class SelectorApplyContentData extends ApplyContentData<SelectorValue> {
    /**
     * Instantiates a new Selector apply content data.
     *
     ...
     */
    @JsonCreator
    SelectorApplyContentData(@JsonProperty("control") ApprovalCtrlType control,
