...
/**
 * The type Punch correction apply content data.
 *
 * @author dax
 * @since 2024/5/27
 */
public class PunchCorrectionApplyContentData extends ApplyContentData<PunchCorrectionValue> {
    /**
     * Instantiates a new Punch correction apply content data.
     *
