...
/**
 * The type Date range apply content data.
 *
 * @author dax
 * @since 2024/5/27
 */
public class DateRangeApplyContentData extends ApplyContentData<DateRangeValue> {
    /**
     * Instantiates a new Date range apply content data.
     *
     ...
     */
    @JsonCreator
    DateRangeApplyContentData(@JsonProperty("control") ApprovalCtrlType control,
