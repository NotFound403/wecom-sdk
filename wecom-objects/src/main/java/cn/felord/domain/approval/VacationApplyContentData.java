...
/**
 * The type Vacation apply content data.
 *
 * @author dax
 * @since 2024/5/27
 */
public class VacationApplyContentData extends ApplyContentData<VacationValue> {
    /**
     * Instantiates a new Vacation apply content data.
     *
     ...
     */
    @JsonCreator
    VacationApplyContentData(@JsonProperty("control") ApprovalCtrlType control,
