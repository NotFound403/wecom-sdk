...
public class MeetingRoomId {
    ...
    /**
     * Instantiates a new Meeting room id.
     *
    ...
    /**
     * From meeting room id.
     *
     * @param meetingRoomId the meeting room id
     * @return the meeting room id
     */
    public static MeetingRoomId from(int meetingRoomId) {
        return new MeetingRoomId(meetingRoomId);
    }
}
