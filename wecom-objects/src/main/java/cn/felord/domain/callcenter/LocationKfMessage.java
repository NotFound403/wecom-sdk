...
public class LocationKfMessage extends KfMessage {
     ...
     */
    @JsonCreator
    public LocationKfMessage(@JsonProperty("msgid") String msgid,
                             ...
                             @JsonProperty("location") KfLocation location) {
        super(KfMsgType.LOCATION, msgid, openKfid, externalUserid, sendTime, origin, servicerUserid);
