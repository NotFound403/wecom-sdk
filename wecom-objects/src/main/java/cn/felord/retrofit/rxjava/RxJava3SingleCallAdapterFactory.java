 ...
 * </ul>
 */
public final class RxJava3SingleCallAdapterFactory extends CallAdapter.Factory {
    /**
     ...
     * factory.
     */
    public static RxJava3SingleCallAdapterFactory create() {
        return new RxJava3SingleCallAdapterFactory(null, true);
    }
     ...
     * are made.
     */
    public static RxJava3SingleCallAdapterFactory createSynchronous() {
        return new RxJava3SingleCallAdapterFactory(null, false);
    }
    ...
    public static RxJava3SingleCallAdapterFactory createWithScheduler(Scheduler scheduler) {
        if (scheduler == null) throw new NullPointerException("scheduler == null");
        return new RxJava3SingleCallAdapterFactory(scheduler, false);
    }

    private final @Nullable Scheduler scheduler;
    private final boolean isAsync;

    private RxJava3SingleCallAdapterFactory(@Nullable Scheduler scheduler, boolean isAsync) {
