...
interface MmPayMktTransfersApi {
    ...
    Single<String> sendWorkWxRedPack(@Body String xmlBody);
    ...
    Single<String> queryWorkWxRedPack(@Body String xmlBody);
    ...
    Single<String> payWwSpTrans2Pocket(@Body String xmlBody);
    ...
    Single<String> queryWwSpTrans2Pocket(@Body String xmlBody);
}
